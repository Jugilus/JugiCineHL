...
public:
    ...
    void SetNavigateForwardJoystickPOV_X(JoystickPOV_X _pov){ joyNavigateForwardPOV_X = _pov; }


    ///\brief Set the joystick POV Y button used for forward navigation between widgets.
    void SetNavigateForwardJoystickPOV_Y(JoystickPOV_Y _pov){ joyNavigateForwardPOV_Y = _pov; }


    ///\brief Set the joystick POV X button used for backward navigation between widgets.
    void SetNavigateBackwardJoystickPOV_X(JoystickPOV_X _pov){ joyNavigateBackwardPOV_X = _pov; }


    ///\brief Set the joystick POV Y button used for backward navigation between widgets.
    void SetNavigateBackwardJoystickPOV_Y(JoystickPOV_Y _pov){ joyNavigateBackwardPOV_Y = _pov; }
    ...
    ///
    /// This function is applicable to GuiSlider widgets.
    void SetIncrementValueJoystickPOV_X(JoystickPOV_X _pov){ joyIncrementValue_POV_X = _pov; }


    ///\brief Set the joystick POV Y button for incrementing the value of the highlighted widget.
    ///
    /// This function is applicable to GuiSlider widgets.
    void SetIncrementValueJoystickPOV_Y(JoystickPOV_Y _pov){ joyIncrementValue_POV_Y = _pov; }


    ///\brief Set the joystick POV X button for decrementing the value of the highlighted widget.
    ///
    /// This function is applicable to GuiSlider widgets.
    void SetDecrementValueJoystickPOV_X(JoystickPOV_X _pov){ joyDecrementValue_POV_X = _pov; }


    ///\brief Set the joystick POV Y button for decrementing the value of the highlighted widget.
    ///
    /// This function is applicable to GuiSlider widgets.
    void SetDecrementValueJoystickPOV_Y(JoystickPOV_Y _pov){ joyDecrementValue_POV_Y = _pov; }
...
private:
    ...
    JoystickPOV_X joyNavigateForwardPOV_X = JoystickPOV_X::NONE;
    JoystickPOV_X joyNavigateBackwardPOV_X = JoystickPOV_X::NONE;
    JoystickPOV_Y joyNavigateForwardPOV_Y = JoystickPOV_Y::NONE;
    JoystickPOV_Y joyNavigateBackwardPOV_Y = JoystickPOV_Y::NONE;
    JoystickPOV_X joyIncrementValue_POV_X = JoystickPOV_X::NONE;
    JoystickPOV_X joyDecrementValue_POV_X = JoystickPOV_X::NONE;
    JoystickPOV_Y joyIncrementValue_POV_Y = JoystickPOV_Y::NONE;
    JoystickPOV_Y joyDecrementValue_POV_Y = JoystickPOV_Y::NONE;
