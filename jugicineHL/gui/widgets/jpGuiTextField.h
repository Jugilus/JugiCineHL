...
struct TextFieldCfg : public GuiWidgetCfg
{

    TextFieldCfg(WidgetFactory *_factory, const std::string &_name) : GuiWidgetCfg(_factory,_name){}

    bool initCfg(const pugi::xml_node &_node) override;


    // area vector shapes
    std::string textRectangle;
    std::string visibleRectangle;
    std::string clickableRectangle;

    //---
    TextAlignment textAlignment = TextAlignment::LEFT;
    TextDrawingDelay textDrawingDelay = TextDrawingDelay::NONE;
    TextScrollingMode textScrollingMode = TextScrollingMode::NORMAL;
    float linesSpacingFactor = 0.0;
    ...
    //---
    std::string sliderCfg;
    std::string sliderSprite;

    std::string scrollDownSprite;
    std::string scrollDownButton;
    std::string scrollUpSprite;
    std::string scrollUpButton;
...
public:
    ...
    GuiTextField(TextFieldCfg *_cfg, CompositeSprite *_rootSprite);
    ...
    void SetScrollingMode(TextScrollingMode _scrollingMode);


    ///\brief Returns the scrolling mode of this text field.
    TextScrollingMode GetScrollingMode(){ return scrollingMode; }
    ...
    void SetDrawingDelay(TextDrawingDelay _drawingDelay, int _drawingdelayMS);


    ///\brief Returns the drawing delay of this text field.
    TextDrawingDelay GetDrawingDelay(){ return drawingDelay; }


    ///\brief Set the text alignment to the given *_textAlignment*.
    void SetTextAlignment(TextAlignment _textAlignment);
...
private:
    ...
    TextFieldCfg *mCfg = nullptr;                           // LINK
    ...
    TextScrollingMode scrollingMode = TextScrollingMode::NORMAL;
    TextAlignment alignment = TextAlignment::LEFT;
    TextDrawingDelay drawingDelay = TextDrawingDelay::NONE;
...
class TextFieldFactory : public WidgetFactory
{
public:

    TextFieldFactory(const std::string &_typeSignature, WidgetType _type) : WidgetFactory(_typeSignature, _type){}
