...
/*
class SetChildState : public ActionCommand
{
public:
    static std::string doType;


    SetChildState(Action*_parentAction, const std::string &_value);
    bool initConnections(PlayedScene *_scene) override;
...
public:
    ...
    CSetSystemParameter(Action*_parentGameAction, const std::string &_value);
    bool initConnections(PlayedScene *_scene) override;
